package com.wiatt.custom_view.xfermode
...
class XfermodeView(context: Context, attrs: AttributeSet): View(context, attrs) {
    ...
    private val circleBitmap = Bitmap.createBitmap(150f.px.toInt(), 150f.px.toInt(),
        Bitmap.Config.ARGB_8888)
    private val squareBitmap = Bitmap.createBitmap(150f.px.toInt(), 150f.px.toInt(),
        Bitmap.Config.ARGB_8888)
